...
export default function JobApplication() {
  ...
  const form = useForm<JobApplicationFormData>({
    ...
    defaultValues: {
      ...
      reasonForLeaving: "",
      liftingCapability: "5-10 kgs",
      jobType: "Short-term job",
      commitmentMonths: 1,
      morningAvailability: "",
  ...
  const onSubmit = (data: JobApplicationFormData) => {
    const submissionData = {
      ...data,
      foundViaInternet: internetSources,
    };
  ...
  const isStudent = form.watch("legalStatus") === "Student";
  const hasSafetyShoes = form.watch("hasSafetyShoes");
  const hasForkliftCert = form.watch("hasForkliftCertification");
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            <RequiredLabel tooltip="Your date of birth (YYYY-MM-DD format)">
                              Date of Birth
                            </RequiredLabel>
                          </FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="647-123-4567" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="ml-6">
                            ...
                            <FormControl>
                              <Input placeholder="e.g., Valid until MM/YYYY" {...field} value={field.value || ""} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {INTERNET_SOURCES.map((source) => (
                        <div key={source} className="flex items-center space-x-2">
                          <Checkbox
                            id={source}
                            checked={internetSources.includes(source)}
                            onCheckedChange={(checked) => {
                              if (checked) {
                                setInternetSources([...internetSources, source]);
                              } else {
                                setInternetSources(internetSources.filter(s => s !== source));
                              }
                            }}
                          />
