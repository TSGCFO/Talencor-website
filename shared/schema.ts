...
export const insertJobApplicationSchema = createInsertSchema(jobApplications).omit({
  ...
  mondaySchedule: z.string().optional(),
  tuesdaySchedule: z.string().optional(),
  wednesdaySchedule: z.string().optional(),
  thursdaySchedule: z.string().optional(),
  fridaySchedule: z.string().optional(),
  saturdaySchedule: z.string().optional(),
  sundaySchedule: z.string().optional(),
  safetyShoeType: z.string().optional(),
  forkliftCertificationValidity: z.string().optional(),
  lastCompanyName: z.string().optional(),
  lastCompanyType: z.string().optional(),
  lastJobResponsibilities: z.string().optional(),
  lastJobAgencyOrDirect: z.string().optional(),
  reasonForLeaving: z.string().optional(),
  commitmentMonths: z.number().min(1, "Commitment period required"),
  morningAvailability: z.string().optional(),
  afternoonAvailability: z.string().optional(),
  nightAvailability: z.string().optional(),
  referralPersonName: z.string().optional(),
  referralPersonNumber: z.string().optional(),
  referralPersonRelationship: z.string().optional(),
  additionalNotes: z.string().optional(),
  recruiterSignature: z.string().optional(),
  aptitudeTestScore: z.number().optional(),
});
